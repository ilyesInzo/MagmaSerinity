...
public class Encaissement implements Serializable {
    ...
    @Column(name = "Enc_TypeEncaissement")
    private int typeEncaissement;

    @Column(name = "Enc_DateEncaissement")
    @Temporal(javax.persistence.TemporalType.TIMESTAMP)
    private Date dateEncaissement;

    @Column(name = "Enc_Montant", scale = 3, precision = 28)
    ...
    @Column(name = "Enc_Ville")
    private String ville;

    @Column(name = "Enc_DateCheque")
    @Temporal(javax.persistence.TemporalType.TIMESTAMP)
    private Date dateCheque;

    @Column(name = "Enc_Tireur")
    private String tireur;

    @Column(name = "Enc_ValeurUnitaireTicket", scale = 3, precision = 28)
    private BigDecimal valeurUnitaireTicket;

    @Column(name = "Enc_NbrTicket")
    private int nbrTicket;

    @Column(name = "Enc_LibelleTicket")
    private String libelleTicket;

    @Column(name = "Enc_DeductionPourcentageTicket", scale = 3, precision = 28)
    private BigDecimal deductionPourcentageTicket;

    @Column(name = "Enc_Supprimer")
    ...
    @Column(name = "Enc_TauxRetenu", scale = 3, precision = 28)
    private BigDecimal tauxRetenu;
    
    // 0: client / 1: Livreur
    @Column(name = "Enc_TypeVente")
    ...
    public AvoirVente getAvoir() {
        return avoir;
    }

    public void setAvoir(AvoirVente avoir) {
        this.avoir = avoir;
    }
    ...
    public boolean equals(Object object) {
        ...
        Encaissement other = (Encaissement) object;
