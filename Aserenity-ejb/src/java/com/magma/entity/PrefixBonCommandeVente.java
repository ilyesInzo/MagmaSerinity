 ...
 */
@Entity
@Table(name = "T_PrefixBonCommandeVente")
public class PrefixBonCommandeVente implements Serializable {
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "PBCVnt_Id")
    private Long id;

    @Column(name = "PBCVnt_Prefixe")
    private String libellePrefixe;

    @Column(name = "PBCVnt_Compteur")
    ...
    @Column(name = "PBCVnt_Supprimer")
    private boolean supprimer;

    @Column(name = "PBCVnt_Description")
    ...
    public boolean equals(Object object) {
        ...
        PrefixBonCommandeVente other = (PrefixBonCommandeVente) object;
