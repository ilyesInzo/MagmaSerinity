 ...
 */
@Entity
@Table(name = "T_PrefixDevis")
public class PrefixDevis implements Serializable {
    ...
    @Column(name = "PDev_Prefixe")
    private String libellePrefixe;

    @Column(name = "PDev_Compteur")
    ...
    @Column(name = "PDev_Supprimer")
    private boolean supprimer;

    @Column(name = "PDev_Description")
    ...
    public boolean equals(Object object) {
        ...
        PrefixDevis other = (PrefixDevis) object;
