...
public class PrefixFacture implements Serializable {
    ...
    @Column(name = "PFa_Prefixe")
    private String libellePrefixe;

    @Column(name = "PFa_Compteur")
    ...
    @Column(name = "PFa_Supprimer")
    private boolean supprimer;

    @Column(name = "PFa_Description")
    ...
    public boolean equals(Object object) {
        ...
        PrefixFacture other = (PrefixFacture) object;
