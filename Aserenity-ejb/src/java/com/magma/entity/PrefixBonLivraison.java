 ...
 */
@Entity
@Table(name = "T_PrefixBonLivraison")
public class PrefixBonLivraison implements Serializable {
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "PBLiv_Id")
    private Long id;

    @Column(name = "PBLiv_Prefixe")
    private String libellePrefixe;

    @Column(name = "PBLiv_Compteur")
    private int compteur;

    @Column(name = "PBLiv_Supprimer")
    private boolean supprimer;

    @Column(name = "PBLiv_Description")
    ...
    public boolean equals(Object object) {
        ...
        PrefixBonLivraison other = (PrefixBonLivraison) object;
