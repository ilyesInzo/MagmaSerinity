 ...
 */
@Entity
@Table(name = "T_LigneBonCommandeCommercial")
public class LigneBonCommandeCommercial implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LigneBonCommandeCommercial)) {
            return false;
        }
        LigneBonCommandeCommercial other = (LigneBonCommandeCommercial) object;
