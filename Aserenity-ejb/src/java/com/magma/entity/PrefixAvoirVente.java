 ...
 */
@Entity
@Table(name = "T_PrefixAvoirVente")
public class PrefixAvoirVente implements Serializable {
    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "PAvnt_Id")
    private Long id;

    @Column(name = "PAvnt_Prefixe")
    private String libellePrefixe;

    @Column(name = "PAvnt_Compteur")
    private int compteur;

    @Column(name = "PAvnt_Supprimer")
    private boolean supprimer;

    @Column(name = "PAvnt_Description")
    ...
    public boolean equals(Object object) {
        ...
        PrefixAvoirVente other = (PrefixAvoirVente) object;
    ...
    public String toString() {
        return "com.magma.entity.PrefixAvoirVente[ id=" + id + " ]";
    }
