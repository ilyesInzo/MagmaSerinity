...
public class EntrepriseFacade extends AbstractFacade<Entreprise> implements EntrepriseFacadeLocal {
    ...
    @Override
    public List<Entreprise> findAllNative(String clause) {
        Query q = (Query) getEntityManager().createNativeQuery("Select * from T_Entreprise as o " + clause + " ", Entreprise.class).setHint(QueryHints.REFRESH, HintValues.TRUE);
