    ...
    public String update() {
        try {
            ...
            if (errorMsg == false) {
                ...
                client.setIdCommercial(selected.getIdCommercial());
                client.setNomCommercial(selected.getNomCommercial());
                client.setPrenomCommercial(selected.getPrenomCommercial());
                client.setTypeCommercial(selected.getType());
